# 公众号配置
# 公众号appId
app_id = "wx3cbca07fb69b007b"
# 公众号appSecret
app_secret = "51c3e9af3597b4f503cc28e6ca91bf9e"
# 模板消息id
# 每日消息
template_id1 = "Y3mxql8wOD2C_AFrKpwF2XlWtWCanWswPg9vsU20fRk"
# 课程消息,上课提醒
...
# 接收公众号消息的微信号
# 这是openid
user = ["oglvZ7TLVFSVkYJaMCwi43wmBPxU"]
...
birthday = "2004-10-29"
# 在一起的日子，格式同上------------计时器
love_date = "2022-10-13"
# 天行数据晚安心语 key
good_Night_Key = "c60d11149b5df4de3c3cba24dc805733"
# -------------------------------------------------------------------------
# 设置学期第一周开始日期
year = 2022
month = 8
